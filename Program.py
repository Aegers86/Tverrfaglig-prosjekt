...
class GUI:
    ...
    def hentAlleKunder(self):                                                                      #Funksjon for å se kundedb med stored procedures
        ...
        AdministrerKunde = tk.Button(kunde_window, text="Administrer kunde", command=lambda: self.administrerKunde())  #Lager knapp som heter "Administrer kunde" og kjører funksjonen update_kunde() i db.py
    ...
    def administrerKunde(self):                                                                      #Funksjon for å se kundedb med stored procedures
        """
        selected_item = self.kunde_tree.selection()                                                       #Lagrer valget ditt (klikket ditt) i variablen selected_item
        if not selected_item:                                                                       #En if statement som kjører dersom du ikke velger noe/klikker på et tomt element
            messagebox.showwarning("Ingen valgt", "Vennligst velg en kunde.")                       #Ber bruker om å velge en ordre og kommer opp som en messagebox/varsel                                                          
        kundenummer = selected_item[0]        
        """
        #Lager nytt vindu for ordre detaljer
        ...
        labelkundenummer = tk.Label(self.kunde_window, text="Kundenummer: ")                                                                 #Setter navn på labelen i vinduet
        labelkundenummer.grid(row=0, column=0, padx=10, pady=10, sticky="e") 
        kundenummer_box = tk.Entry(self.kunde_window)                                                                 #Lager entryboks for kundenummer
        kundenummer_box.grid(row=0, column=1, padx=10, pady=10, sticky="nsew")  
                                                                      #Pakker det hele sammen. Vi velger også å vise kundedataene til venstre i visningsvinduet
        labelFornavn = tk.Label(self.kunde_window, text="Fornavn: ")
        labelFornavn.grid(row=1, column=0, padx=10, pady=10, sticky="e")                                                        #Setter størrelse på popupvinduet
        fornavn_box = tk.Entry(self.kunde_window)                                                                 #Lager entryboks for fornavn
        fornavn_box.grid(row=1, column=1, padx=10, pady=10, sticky="nsew")  
                                                                      #Pakker det hele sammen. Vi velger også å vise kundedataene til venstre i visningsvinduet
        labelEtternavn = tk.Label(self.kunde_window, text="Etternavn: ")
        labelEtternavn.grid(row=2, column=0, padx=10, pady=10, sticky="e")
        etternavn_box = tk.Entry(self.kunde_window,text="Etternavn")                                                                 #Lager entryboks for etternavn
        etternavn_box.grid(row=2, column=1, padx=10, pady=10, sticky="nsew")                                                                 #Pakker det hele sammen. Vi velger også å vise kundedataene til venstre i visningsvinduet
        
        labelAdresse = tk.Label(self.kunde_window, text="Adresse: ")
        labelAdresse.grid(row=3, column=0, padx=10, pady=10, sticky="e")
        addresse_box = tk.Entry(self.kunde_window)                                                                 #Lager entryboks for adresse
        addresse_box.grid(row=3, column=1, padx=10, pady=10, sticky="nsew")                                                                #Pakker det hele sammen. Vi velger også å vise kundedataene til venstre i visningsvinduet
        
        laberlPostnr = tk.Label(self.kunde_window, text="Postnummer: ")
        laberlPostnr.grid(row=4, column=0, padx=10, pady=10, sticky="e")                                                        #Setter størrelse på popupvinduet
        postnr_box = tk.Entry(self.kunde_window)                                                                 #Lager entryboks for postnummer
        postnr_box.grid(row=4, column=1, padx=10, pady=10, sticky="nsew")                                                                 #Pakker det hele sammen. Vi velger også å vise kundedataene til venstre i visningsvinduet
        
        SlettKunde = tk.Button(self.kunde_window, text="Slett kunde", bg="red", fg="white", command=lambda: self.slettKunde())  #Lager knapp som heter "Slett kunde" og kjører funksjonen delete_kunde() i db.py
        SlettKunde.grid(row=6, column=0, padx=10, pady=10, sticky="nsew")

        lagreKunde = tk.Button(self.kunde_window, text="Lagre kunde", command=lambda: self.lagreKunde())  #Lager knapp som heter "Lagre kunde" og kjører funksjonen insert_kunde() i db.py
        lagreKunde.grid(row=6, column=1, padx=10, pady=10, sticky="nsew")                                                                 #Pakker det hele sammen. Vi velger også å vise kundedataene til venstre i visningsvinduet
    ...
    def slettKunde(self, kundenummer):                                                                      #Funksjon for å se kundedb med stored procedures

        messagebox.showwarning("Er du helt sikker?")                               #Oppretter messagebox
        self.db.update_one("UPDATE kunde SET is_active = '0' WHERE KNr = %s;", (kundenummer,))                     #Oppdaterer databasen med slettingen av kundenummeret som er valgt i treeviewen.
